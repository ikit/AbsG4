...
function validateForm() 
{
    ...
    {
        msgError += "Le titre doit être renseigné.\n";
    }
    if (tinymce.get('message').getContent() === "" ) 
    {
        msgError += "Le message ne peut rester vide.\n";
    }
...
function startWritting(action)
{
	...
	$('#editor').append( '<form method="post" action="'+baseURL+'forum/newp/'+action+'" onsubmit="return validateForm()"><textarea name="message" id="message"></textarea><input type="submit" value="Envoyer ma réponse"/></form><br/>' );
