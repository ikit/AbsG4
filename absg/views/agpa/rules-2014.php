...
<h1>Règlement des AGPA <?php echo $current_phase_year; ?></h1> 
...
<ul>
	...
	<li><b>Spéciale :</b> hotos correspondant au thème défini en début d’année (sauf pour l’entrée en vigueur de cette catégorie en 2012). Une photo en rapport au thème de l’année doit impérativement être placée dans cette catégorie (sauf photo retouchée, destinée à Autre regard);</li>
...
<dl>
	...
	<dt>2011</dt>
	<dd>Depuis 2011, un AGPA du meilleur titre est attribué, selon des modalités particulières.</dd>
	<dt>2012</dt>
	<dd>Ajout catégorie enfants et spéciale</dd>
	<dt>2013</dt>
	<dd>Un nouveau système de vote destiné à faire face au nombre croissant de photos, qui a progressivement rendu inadapté le système de vote initial. Modification des catégories historiques, mise en place nouvelle version du site des AGPA (V4) avec systeme de vote du meilleur titre intégré</dd>
</dl></p>

<p>Le déroulement de l’édition des AGPA <?php echo $current_phase_year; ?> est détaillé ci-dessous. Les dates et heures indiquées ne sont pas immuables ; elles pourront être modifiées si les circonstances l’exigent (les candidats seront alors prévenus sur le forum Absolument G).</p>
...
<ul>
	...
	<li>Avoir été prise par le candidat entre le 9 décembre <?php echo $prev_year; ?> et le 14 décembre <?php echo $current_phase_year; ?>. Les photos prises au retardateur sont admises, si le candidat a préparé l’appareil et cadré la photo lui-même ;</li>
...
<ul>
	...
	<li>Les effets stimulants une technique ou un effet photographique traditionnel (polaroïd, vignetage, grain…) ;</li>
...
<p>La date limite d’enregistrement des photos est fixée au <?php echo $p1_end_date; ?> décembre <?php echo $current_phase_year; ?> à 23h59. Avant cette date, le candidat peut :
<ul>
...
<p>Du <?php echo $p2_start_date; ?> décembre <?php echo $current_phase_year; ?> (0h00) au <?php echo $p2_end_date; ?> décembre <?php echo $current_phase_year; ?> (23h59), les photos sont affichées sur le site Absolument G, dans la section consacrée aux AGPA. </p>
...
<p>Si une photo est jugée non conforme aux critères définis, le candidat concerné sera prévenu et aura la possibilité de remplacer son œuvre jusqu’au <?php echo $p2_end_date; ?> décembre <?php echo $current_phase_year; ?> 23h59. S’il ne le fait pas, la photo en cause pourra être supprimée par l’organisation. </p>
...
<p>Le vote est ouvert à tous les membres du forum Absolument G. </p>

<p>La phase de vote s’étend du <?php echo $p3_start_date; ?> décembre <?php echo $current_phase_year; ?> (0h00) jusqu'au <?php echo $p3_end_date; ?> décembre <?php echo $current_phase_year; ?> (23h59). </p>

<p>Pendant cette période, les membres du forum peuvent :
<ul>
	<li>Visualiser les photos de tous les candidats ;</li>
	<li>Voter pour les meilleures photos parmi celles envoyées par les autres candidats, en  ajoutant une ou deux étoiles supplémentaires à ses photos préférées, dans la limite d’un nombre d’étoiles égal à la moitié du nombre de photos de la catégorie ;
	<li>Voter pour les meilleurs titres, toutes catégories confondues, en sélectionnant huit titres au choix parmi l’ensemble des photos (sans limite par catégorie) ;</li>
	<li>Corriger leurs votes</li>
</ul></p>

<p>Dans ce système, toutes les photos ont au moins une étoile, attribuée par défaut, et au maximum trois étoiles. Chaque étoile ajoutée correspond à un point ajouté. Le fait d’ajouter une (ou deux) étoile(s) correspond à un vote.</p>
<p>Les candidats doivent attribuer au moins la moitié de leurs étoiles. S'ils ne le font pas, pour les catégories concernées, leurs votes partiels ne seront pas pris en compte.</p>
...
<ul>
	<li>L’AGPA d’or du meilleur titre (décerné selon les modalités indiquées dans le paragraphe <a href="#chap5.2" class="number" title="Aller au paragraphe V.2">V.2</a>) ;</li>
...
<p>Le changement de système de vote de 2013 ne change pas les règles de calcul de cette note, qui reste pertinente et continue à servir de référence pour le classement des photos et l’attribution des récompenses.</p>
...
<p>En cas de notes équivalentes, deux photos sont départagées par les critères suivants (par ordre d’application) :<ul>
	<li>Nombre de votes reçus (avantage au plus grand nombre) ;</li>
...
<p>L’AGPA d’or du meilleur titre est attribué selon les modalités suivantes : <ul>
	<li>Les 4 photos dont les titres ont obtenu le plus de votes sont nominées pour la finale (en cas d’égalité, on retient la photo ayant le plus petit score général) ;</li>
	<li>L’AGPA d’or du meilleur titre est décerné à l’une de ces quatre photos le jour de la cérémonie, selon un protocole spécifique et susceptible de changer d’une année sur l’autre (à l’applaudimètre en 2011, 2012 et 2013).</li>
</ul></p>



<p>Le classement du meilleur photographe est calculé à partir de la somme des notes des huit meilleures photos de chaque participant, ou de toutes les photos des participants ayant proposés huit photos ou moins.</p>
...
<p>Dans certains cas bien précis, les AGPA d’or peuvent se transformer en AGPA de diamant : <ul>
	<li>AGPA de diamant du meilleur titre attribué à la photo présentant le meilleur titre si :<ul>
		<li>Le titre est celui qui a obtenu le plus de points lors de la phase de sélection et que ce total est au moins égal au double du score du deuxième meilleur titre ;</li>
	</ul></li>
...
<table><tbody>
	...
	<tr><th>Meilleur photographe                 </th><td>6</td><td>5</td><td>4</td><td>3</td></tr>
	<tr><th>Meilleure photographie (général)     </th><td>5</td><td>4</td><td>3</td><td>2</td></tr>
	<tr><th>Meilleure photographie (catégorie)   </th><td>4</td><td>3</td><td>2</td><td>1</td></tr>
	<tr><th>Meilleure titre                      </th><td>4</td><td>3</td><td>2</td><td>1</td></tr>
</tbody></table>
</p>
...
<p class="version">Règlement officiel des AGPA – Edition 2014 – Version du 7 décembre 2014</p>
<div class="clear">&nbsp;</div>
</div>
